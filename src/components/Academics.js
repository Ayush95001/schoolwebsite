    ...
    return(
      ...
      <div className="col division"> 
        <div className="card h-100">
          <img src={Image7} className="card-img-top" alt="Card image" />
      ...
      <div className="col division">
        <div className="card h-100">
          <img src={Image8} className="card-img-top" alt="Card image" />
          <hr/>
          <div className="card-body">
      ...
      <div className="col division">
        <div className="card h-100">
          <img src={Image9} className="card-img-top" alt="Card image" />
          <hr/>
          <div className="card-body">
