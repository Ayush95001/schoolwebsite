    ...
    return(
      ...
      <div className="col division"> 
        <div className="card h-100">
          <img src="https://www.thebluediamondgallery.com/handwriting/images/process.jpg"  alt="" className="card-img-top"  />
      ...
      <div className="col division">
        <div className="card h-100">
          <img src="https://st2.depositphotos.com/3591429/9132/i/950/depositphotos_91327562-stock-photo-criteria-controlling-concept.jpg" alt="" className="card-img-top"  />
          <div className="card-body">
      ...
      <div className="col division">
        <div className="card h-100">
          <img src="https://www.bssc.edu.au/wp-content/uploads/2016/11/Important-dates-1.jpg" alt="" className="card-img-top"  />
          <div className="card-body">
